    ...
    <div className="mx-auto max-w-[1800px] space-y-4 p-4 sm:p-6">
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm leading-6 text-ink-muted">
          Every genetic individual seen anywhere in this simulation, placed on a real horizontal
          time axis. Non-breeding littermates are collapsed by default so a whole-farm pedigree
          stays navigable; click a litter or search a tag to open the individual pigs.
        </p>
      </div>
      <PedigreeGraph
